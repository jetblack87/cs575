(function() {
	...
	// Define the different controllers and routes - one for each type of
	// "details" page
	...
	app.controller('TreeController', function($scope, $http, $interval) {
	...
	app.controller('ProcessesController', function($scope, $http, $routeParams) {
		...
		// Actually get the process data when the controller
		// first runs
